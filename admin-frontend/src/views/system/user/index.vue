    ...
    return {
      ...
      rules: {
        userName: [
          ...
          {  max: 30, message: '请输入30个字节以内的名称', trigger: 'blur' }
        ],
        nickName: [
          { required: true, message: "用户昵称不能为空", trigger: "blur" },
          {  max: 30, message: '请输入30个字节以内的昵称', trigger: 'blur' }
        ],
        password: [
          { required: true, message: "用户密码不能为空", trigger: "blur" },
          { max: 20, message: '请输入30个字节以内的密码', trigger: 'blur' }
        ],
        email: [
          {
            type: "email",
          ...
          {max: 50, message: '请输入50个字节以内的邮箱', trigger: 'blur' }
        ],
        phonenumber: [
          {
